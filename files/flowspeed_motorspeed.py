...
def calculate_stepspeed(channel_m_per_s = 1, syringe_diameter = 12.08, channel_area_sqmm = 0.03*0.1):
    ...
    syringe_m_second = channel_m_per_s*channel_area_sqmm/syringe_area_sqmm
